...
fun HomeScreen(
    ...
    val viewModel: HomeViewModel = viewModel(
        factory = viewModelFactory {
            initializer { HomeViewModel(container.alicuotasRepository, container.invitadosRepository) }
        }
    )
    ...
    Scaffold { padding ->
        ...
        LazyColumn(
            ...
            item {
                Card(modifier = Modifier.fillMaxWidth(), onClick = onVerBasura) {
                    Column(Modifier.padding(16.dp)) {
            ...
            item {
                Text("Invitados pendientes de ingreso", style = MaterialTheme.typography.titleMedium)
            }
